...
(b)  \myvec{3&-1}\vec{x}=0
\end{align}
let \vec{x}=\myvec{a\\0} substitute in \eqref{eq:2}
\begin{center}
...
\begin{align}
    \vec{a}=0
\end{align}
similarly let \vec{x}=\myvec{0\\b}substitute in \eqref{eq:2}
\begin{align}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=\columnwidth]{graph assign 4.png}
